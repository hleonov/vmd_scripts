...
# run : vmd -dispdev text -e ./position_amn.tcl -args initial_system.pdb <dz> 1/0 for z_trans
...
proc move_amn {dz} {
	global z_trans amn amn_n num v1 v2 prot vec_dist
