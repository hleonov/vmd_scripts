...
source ~isaiahar/shy_utilities.tcl
check_for_help "Usage: vmdt -e move_waters.tcl -args -rf system_hole.pdb sol.pdb hoh_moved.pdb"
if {[lindex $argv 0] == "-rf"} {
...
set cmd "cat hoh_moved_*.pdb | grep ATOM > new_hoh_moved.pdb"
exec sh -c $cmd 
exit
